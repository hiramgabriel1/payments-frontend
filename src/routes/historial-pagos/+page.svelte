      ...
      <div class="flex items-center gap-x-3">
        ...
        {#if clientesHistorial}
          <span
            ...
            >{clientesHistorial.length} clientes</span
          >
        {:else}
          <span
            class="px-3 py-1 text-xs text-blue-600 bg-blue-100 rounded-full dark:bg-gray-800 dark:text-blue-400"
                    ...
                    <td class="px-4 py-2">
                      {#if client.capitalPrestado === undefined}
                        <progress></progress>
                         ...
                         <button on:click={() => {alert(client._id)}} class="text-slate-800 hover:text-blue-600 text-sm bg-white hover:bg-slate-100 border border-slate-200  font-medium px-4 py-2 inline-flex space-x-1 items-center">
                            <span>
