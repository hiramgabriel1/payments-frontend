<script>
  ...
  export async function deleteClients(idDelete) {
  ...
  <tr>
    ...
    <td class="px-4 py-4 text-sm whitespace-nowrap">
      <div class="inline-flex items-center rounded-md shadow-sm">
        ...
        <button
          on:click={() => mostrarModalDetail(element)}
        ...
        <!--Eliminar usser-->
        <button
          on:click={() => mostrarModalDelete(element)}
    ...
    >
      ...
      <div class="z-10 bg-white rounded-lg shadow-lg w-2/3">
        ...
        <div class="flex justify-between px-8 pb-8">
          <div>
            <button
              on:click={() => deleteClients(client._id)}
